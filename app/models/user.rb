class User < ApplicationRecord
  ...
  has_many :followers, through: :passive_relationships#, source: :follower ## follower is not needed since it does it automatically
  ...
  def remember
    ...
    #puts "Temporary dump of remember token for this exercise:"
    #puts self.remember_token #temporary for exercise 2.2 in chapter 9
  ...
  # Commented above and added this instead:
